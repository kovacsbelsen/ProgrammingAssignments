...
public static void main(String[] args) {
    ...
    for (int j=0; j < swear.length; j++) {
        ...
        Pattern p = Pattern.compile("\\b" + swear[j] + "\\b", Pattern.CASE_INSENSITIVE);    // the "\\b" checks if the character between and after the pattern (j element of swear array) is not a word letter
